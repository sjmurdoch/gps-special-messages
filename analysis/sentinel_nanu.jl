...
#   - all-¬ (0xAC)   — the dominant sentinel, persisted 10+ years
...
Classify a zero-entropy message into one of: "all_ac", "all_nul", "all_space".
...
function sentinel_display_name(sentinel_type::String)::String
    sentinel_type == "all_ac"    && return "all-¬ (0xAC)"
